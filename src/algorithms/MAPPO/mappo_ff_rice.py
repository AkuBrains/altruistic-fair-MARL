...
from jaxenv.environments.rice.util import logwrapper_callback
...
def build_trainer(
    ...
    rng, network_key, reset_key = jax.random.split(rng, 4)
    ...
    actors, critics = create_mappo_networks(
        ...
        global_state_size=env.state_space_shape,
