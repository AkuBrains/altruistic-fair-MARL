...
from jaxenv.environments.common_harvest import Harvest_open
from ..utils import BaseTrainerParams
from utils import logwrapper_callback, COMMON_HARVEST, MAPPO
...
class Critic(eqx.Module):
    ...
    def __call__(self, x: jax.Array) -> jax.Array:
        ...
        value_output = self.value(hidden_state)
        ...
        def _update_epoch(update_state, _):
            ...
            def __ppo_los_fn(params, trajectory_minibatch, advantages, returns):
                ...
                if config.a2c_mode:
                    ...
                    _advantages = (advantages - advantages.mean(axis=0)[None, :]) / (
                        advantages.std(axis=0)[None, :] + 1e-8
                    )
